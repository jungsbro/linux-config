...
# ENV ==========================================================================
# ------------------------------------------------------------------------------
# /.config/distrobox/ubu/install_ubu-main.sh
...
# distrobox create --name "ubu-main" --image "docker.io/library/debian:latest"
ctr_args=""
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    # # installation
    # distrobox enter ${ctr} -- sudo apt install -y firefox
    ...
    # qpdf ---------------------------------------------------------------------
    # installation
    distrobox enter ${ctr} -- sudo apt install -y qpdfview qpdfview-djvu-plugin \
