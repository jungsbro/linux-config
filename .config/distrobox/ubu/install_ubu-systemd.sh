...
# ENV ==========================================================================
# ------------------------------------------------------------------------------
# /.config/distrobox/ubu/install_ubu-systemd.sh
...
# ------------------------------------------------------------------------------
CTR_NAME="ubu-systemd"

IMAGE="docker.io/library/ubuntu:latest"

# distrobox create --name "ubu-systemd" --image "docker.io/library/debian:latest"
CTR_ARGS=""
