...
# distrobox create --name "nk1600box" --image "docker.io/library/rockylinux:9.3"
ctr_args=""
ctr_args+="--name $ctr "
...
# 0) 패키지 업그레이드 .............................................................
upgrade_cmds+="sudo dnf upgrade -y"

# "--init --additional-packages systemd" 사용할때는 아래처럼 해야 한다.
# upgrade_cmds+="sudo dnf upgrade -y --exclude=filesystem,setup"
# ..............................................................................
...
if [[ -n "$upgrade_cmds" ]]; then
    distrobox enter "$ctr" -- bash -c "$upgrade_cmds";
fi
