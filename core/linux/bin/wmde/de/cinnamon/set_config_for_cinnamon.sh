...
# usage ========================================================================
# bash ${CORE_BIN_DIR}/wmde/de/cinnamon/set_config_for_cinnamon.sh "${CUR_USER}";

# dbus-run-session bash ${CORE_BIN_DIR}/wmde/de/cinnamon/set_config_for_cinnamon.sh "${CUR_USER}";
# ==============================================================================
