...
# Funcs ========================================================================
function install_gnome-extensions_for_arch()
{
    # --------------------------------------------------------------------------
    # gnome-shell (gnome)
...
function install_gnome-extensions_for_debian()
{
    # --------------------------------------------------------------------------
    # gnome-shell (gnome)
...
function install_gnome-extensions_for_ubuntu()
{
    # --------------------------------------------------------------------------
    # gnome-shell (gnome)
    local app_name="gnome-shell"; apt-cache show "${app_name}" &>/dev/null && apt install -y --no-reinstall "${app_name}" || true
...
function install_gnome-extensions_for_fedora()
{
    # --------------------------------------------------------------------------
    # gnome-shell (gnome)
...
function install_gnome-extensions_for_rhel()
{
    # --------------------------------------------------------------------------
    # gnome-shell (gnome)
    local app_name="gnome-shell"; dnf info "${app_name}" &>/dev/null && dnf install -y "${app_name}" || true
...
function execute_main()
{
    if [[ "${CUR_VER}" == *"archlinux"* ]]; then
        install_gnome-extensions_for_arch;

    elif [[ "${CUR_VER}" == *"debian.org"* ]]; then
        install_gnome-extensions_for_debian;

    elif [[ "${CUR_VER}" == *"ubuntu"* ]]; then
        install_gnome-extensions_for_ubuntu;

    elif [[ "${CUR_VER}" == *"Fedora"* ]]; then
        install_gnome-extensions_for_fedora;

    elif [[ "${CUR_VER}" == *"CentOS"* ]] || [[ "${CUR_VER}" == *"rocky"* ]]; then
        install_gnome-extensions_for_rhel;
    fi
}
# ==============================================================================
