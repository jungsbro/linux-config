...
function install_gpudrv_for_pacman()
{
    # --------------------------------------------------------------------------
...
function install_gpudrv_for_apt()
{
    # --------------------------------------------------------------------------
    ...
    if [[ *"${VENDOR}"* == *"nvidia"* ]]; then
        ...
        if [[ ! -f "/usr/bin/distrobox" ]] && [[ -f "/usr/bin/distrobox-export" ]]; then  # container
            ...
            # ------------------------------------------------------------------
            # /usr/share/vulkan/icd.d/nvidia_icd.json 이 없을때 설치
            # /etc/vulkan/icd.d/nvidia_icd.json 이 없을때 설치
...
function install_gpudrv_for_dnf()
{
    # --------------------------------------------------------------------------
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    if [[ *"${CUR_VER}"* == *"archlinux"* ]]; then
        # ----------------------------------------------------------------------
        install_gpudrv_for_pacman
        # ----------------------------------------------------------------------

    elif [[ *"${CUR_VER}"* == *"debian"* ]] || [[ *"${CUR_VER}"* == *"ubuntu"* ]]; then
        # ----------------------------------------------------------------------
        install_gpudrv_for_apt;
        # ----------------------------------------------------------------------

    elif [[ *"${CUR_VER}"* == *"CentOS"* ]] || [[ *"${CUR_VER}"* == *"rocky"* ]] || [[ *"${CUR_VER}"* == *"Fedora"* ]]; then
        # ----------------------------------------------------------------------
        install_gpudrv_for_dnf;
        # ----------------------------------------------------------------------
    fi
    # --------------------------------------------------------------------------
