...
function execute_main()
{
    ...
    if [[ "${VENDOR}" == *"nvidia"* ]]; then
        bash ${CORE_BIN_DIR}/gpu/cli/install_gpu_nvidia.sh "${CUR_USER}";

    elif [[ "${VENDOR}" == *"radeon"* ]]; then
        bash ${CORE_BIN_DIR}/gpu/cli/install_gpu_radeon.sh "${CUR_USER}";

    elif [[ "${VENDOR}" == *"intel"* ]]; then
        bash ${CORE_BIN_DIR}/gpu/cli/install_gpu_inel.sh "${CUR_USER}";
    fi
    # --------------------------------------------------------------------------
}
# ==============================================================================
