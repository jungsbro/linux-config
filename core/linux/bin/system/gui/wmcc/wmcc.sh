...
# usage ========================================================================
# bash ${CORE_BIN_DIR}/system/gui/wmcc/wmcc.sh;
...
# ENV ==========================================================================
# ------------------------------------------------------------------------------
# /core/linux/bin/system/gui/wmcc
...
function create_db()
{
    ...
    do
        ...
        do
            ...
            cur_name=$(crudini --get "${cur_path}" "Desktop Entry" "Name" 2>/dev/null || true);
            cur_exec=$(crudini --get "${cur_path}" "Desktop Entry" "Exec" 2>/dev/null || true);
            cur_icon=$(crudini --get "${cur_path}" "Desktop Entry" "Icon" 2>/dev/null || true);
            cur_cat=$(crudini --get "${cur_path}" "Desktop Entry" "Categories" 2>/dev/null || true);
