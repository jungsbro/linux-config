...
function execute_main()
{
    if [[ "${CUR_RELEASE}" == *"archlinux"* ]]; then
        ...
        # ime ------------------------------------------------------------------
        # 방법1)
        # bash ${CORE_BIN_DIR}/ime/gui/install_fcitx.sh "${CUR_USER}";

        # 방법2)
        bash ${CORE_BIN_DIR}/ime/gui/install_fcitx5.sh "${CUR_USER}";

        # 방법3)
        # bash ${CORE_BIN_DIR}/ime/gui/install_ibus.sh "${CUR_USER}";

        # 방법4)
        # bash ${CORE_BIN_DIR}/ime/gui/install_kime.sh "${CUR_USER}";

        # 방법5)
        # bash ${CORE_BIN_DIR}/ime/gui/install_nimf.sh "${CUR_USER}";

        # 방법6)
        # bash ${CORE_BIN_DIR}/ime/gui/install_uim.sh "${CUR_USER}";
        # ----------------------------------------------------------------------
