...
# usage ========================================================================
# bash ${CORE_BIN_DIR}/ime/gui/install_nimf.sh "${CUR_USER}";
# ==============================================================================


# ENV ==========================================================================
# ------------------------------------------------------------------------------
# /core/linux/bin/ime/gui
...
function get_libhangul-pc()
{
    ...
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_libhangul.sh && build_libhangul_for_dnf;
    # --------------------------------------------------------------------------
...
function get_m17n-pc()
{
    ...
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_m17n-lib.sh && build_m17n-lib_for_dnf;

    # # /usr/local/share/pkgconfi/m17n-db.pc
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_m17n-db.sh && build_m17n-db_for_dnf;
    # --------------------------------------------------------------------------
...
function get_anthy-pc()
{
    ...
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_anthy_9100h.sh && build_anthy-9100h_for_dnf;
    # --------------------------------------------------------------------------
...
function get_rime-pc()
{
    ...
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_marisa-trie.sh && build_marisa-trie_for_dnf;

    # # /usr/local/lib64/pkgconfig/opencc.pc
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_opencc.sh && build_OpenCC_for_dnf;

    # # /usr/local/lib64/pkgconfig/rime.pc
    # source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_rime.sh && build_rime_for_dnf;
    # --------------------------------------------------------------------------
...
{
    # --------------------------------------------------------------------------
    chmod -R +x "${CORE_BIN_DIR}/ime/gui/nimf_for_build";
    # --------------------------------------------------------------------------
    ...
    # /usr/local/lib/pkgconfig/nimf.pc
    source ${CORE_BIN_DIR}/ime/gui/nimf_for_build/build_nimf.sh && build_nimf_for_dnf "${CUR_USER}";
    # --------------------------------------------------------------------------
}
# ==============================================================================
