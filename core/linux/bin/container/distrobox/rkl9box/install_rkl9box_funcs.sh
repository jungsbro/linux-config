...
[[ -n "${_INSTALL_RKL9BOX_FUNCS_LOADED:-}" ]] && return 0
_INSTALL_RKL9BOX_FUNCS_LOADED=1
...
# Funcs ========================================================================
function get_core_bin_dir_from_rkl9box()
{
...
function get_ctr_args()
{
    ...
    # --------------------------------------------------------------------------
    # distrobox create --name "fedo-main" --image "docker.io/library/rockylinux:9.3"
    local ctr_args=""
...
function get_pre_init_hooks()
{
    ...
    # core/linux/bin
    local core_bin_dir=$(get_core_bin_dir_from_rkl9box);
    # --------------------------------------------------------------------------
