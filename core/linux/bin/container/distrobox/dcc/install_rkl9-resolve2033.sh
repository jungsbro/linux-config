...
# usage ========================================================================
# bash ${CORE_BIN_DIR}/container/distrobox/dcc/install_rkl9-resolve2033.sh
# ==============================================================================
...
# distrobox create --name "rkl9-resolve2033" --image "docker.io/library/rockylinux:9.3"
CTR_ARGS=""
...
function execute_main()
{
    ...
    # davinci-resolve 2033 -----------------------------------------------------
    bash ${CUR_DIR}/add_resolve2033.sh "${CTR_NAME}"
    # --------------------------------------------------------------------------
}
# ==============================================================================
