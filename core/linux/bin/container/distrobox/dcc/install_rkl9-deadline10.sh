...
# usage ========================================================================
# bash ${CORE_BIN_DIR}/container/distrobox/dcc/install_rkl9-deadline10.sh
# ==============================================================================
...
# distrobox create --name "rkl9-deadline10" --image "docker.io/library/rockylinux:9.3"
CTR_ARGS=""
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    # deadline10 (launcher) ----------------------------------------------------
    bash ${CUR_DIR}/add_deadline10.sh "${CTR_NAME}"
    # --------------------------------------------------------------------------
