...
# Funcs ========================================================================
# function install_qterminal_for_nix()
# {
...
#     # nix-env -iA nixpkgs.qterminal
#     # nix profile add nixpkgs#qterminal
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    if [[ *"${CUR_VER}"* == *"archlinux"* ]]; then
        ...
        # install_qterminal_for_nix "single";
