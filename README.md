...
> fstab 설정
```bash
sudo mkdir /mnt/{a3004ns,j1900,rpi44,rpi48};
sudo vi /etc/fstab;
```
```bash
...
//192.168.0.0/contents  /mnt/j1900   cifs    username=id,password=1234,iocharset=utf8,vers=2.0,uid=1000,gid=1000,x-systemd.automount  0   0

//192.168.0.0/contents  /mnt/rpi44   cifs    username=id,password=1234,iocharset=utf8,vers=2.0,uid=1000,gid=1000,x-systemd.automount   0   0

//192.168.0.0/contents  /mnt/rpi48   cifs    username=id,password=1234,iocharset=utf8,vers=2.0,uid=1000,gid=1000,x-systemd.automount   0   0
...
```
```bash
192.168.0.100:/nfs /mnt/nfs nfs defaults 0 0
```
<br><br>
...
1. xrdp 설치
```bash
sudo apt install xserver-xorg-core xrdp xserver-xorg-input-all
```
